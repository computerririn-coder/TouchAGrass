    ...
    <section className="bg-[#242424] w-full min-h-[50vh] flex flex-col items-center pt-12 px-4 text-amber-400 pb-20 gap-7">
      ...
      <div className="flex flex-row gap-55 flex-wrap items-center justify-center">
        <FeatureCard
          imageSrc={Grass}
          title="Life Changing"
          description="You will never find the true meaning of life if you don’t use this website."
        />
        <FeatureCard
          imageSrc={Grass}
        ...
        <FeatureCard
          ...
          description="Magically increases your luck in ways you never expected."
        />
      </div>
    </section>
  );
